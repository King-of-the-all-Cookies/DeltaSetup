if (i_ex(obj_tenna_zoom) && (obj_tenna_zoom.minigameinsanityintro || obj_tenna_enemy.phaseturn == 18))
{
    ...
    if (!i_ex(obj_tvturnoff_manager))
        draw_text_color((camerax() + camerawidth()) - 22, cameray() + 10, stringsetsubloc("Ch~1", string(_channelnumber), "obj_tenna_minigame_ui_slash_Draw_0_gml_1_0"), c_lime, c_lime, c_lime, c_lime, 1);
...
{
    draw_text_transformed(camerax() + score_x + 140, ((cameray() + bar_y) - 5) + 70, stringsetloc("ENEMY", "obj_tenna_minigame_ui_slash_Draw_0_gml_2_0"), 3, 2, 0);
...
{
    draw_text_transformed(camerax() + score_x, (cameray() + bar_y) - 5, stringsetloc("ENEMY", "obj_tenna_minigame_ui_slash_Draw_0_gml_2_0"), 3, 2, 0);
...
draw_text_transformed(camerax() + score_x, cameray() + score_y, stringsetloc("SCORE", "obj_tenna_minigame_ui_slash_Draw_0_gml_3_0"), 3, 2, 0);
draw_set_halign(fa_right);
...
draw_text_transformed_color((camerax() + box_x) - 93, cameray() + box_y + 18, stringsetloc("MISS", "obj_tenna_minigame_ui_slash_Draw_0_gml_4_0"), 3, 2, 0, blend1, blend1, blend1, blend1, 1);
