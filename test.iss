...
[Files]
; Патчер (вшиваем прямо в установщик)
Source: "DeltarunePatcherCLI.exe"; DestDir: "{tmp}"; Flags: dontcopy
...
// Извлекаем патчер из ресурсов установщика
procedure ExtractPatcher;
begin
  ExtractTemporaryFile('DeltarunePatcherCLI.exe');
end;
